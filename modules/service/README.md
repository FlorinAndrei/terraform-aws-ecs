...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | The VPC ID where to deploy the task or service. If not provided, the VPC ID is derived from the first subnet provided (requires the subnet to exist at plan time) | `string` | `null` | no |
